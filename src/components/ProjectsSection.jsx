...
const projects = [
  {
    ...
    image: projectImg,
    description:
      "Personal portfolio website showcasing my projects, experience, and skills as a fullstack developer.",
        ...
        {projects.map((project, idx) => (
          ...
          >
            ...
            <div className="p-5 flex flex-col flex-1">
              ...
              <p className="text-neutral-300 text-sm mb-3 flex-1">
                {project.description}
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech, i) => (
                  <span
                    key={i}
                    className="bg-white/10 text-white text-xs px-3 py-1 rounded"
                  >
                    {tech}
                  </span>
                ))}
