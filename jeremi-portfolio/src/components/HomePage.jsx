  ...
  return (
    <div className="min-h-screen w-full bg-[#0f172a] flex flex-col items-center px-2 sm:px-4">
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 bg-[#0f172a] hover:bg-[#1e293b] border border-gray-700 text-white p-2 md:p-4 rounded-full transition-colors duration-200 shadow-lg focus:outline-none focus:ring-2 focus:ring-white"
